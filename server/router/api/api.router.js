...
router.post("/send", controller.sendUnified.bind(controller));
...
router.get("/callback", controller.getCallbackConfig.bind(controller));
router.post("/callback", controller.setCallbackConfig.bind(controller));
router.delete("/callback/:session_name", controller.deleteCallbackConfig.bind(controller));
